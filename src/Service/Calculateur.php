...
class Calculateur extends AbstractController
{
     ...
     * @throws LoaderError
     */
    public function majAide(Utilisateur $utilisateur, EntityManagerInterface $entityManager, MailerService $mailerService): Resultat
    {
        ...
        // ancien resultat à mettre à jour
